    ...
    <div class="auth-page animate-fade-in">
      <div class="auth-card">
        ...
        <div class="social-login-grid">
          <button type="button" class="btn-social btn-google btn-disabled" disabled title="Google OAuth integration coming soon">
          ...
          <button type="button" class="btn-social btn-apple btn-disabled" disabled title="Apple ID OAuth integration coming soon">
